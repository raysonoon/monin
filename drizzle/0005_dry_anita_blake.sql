...
INSERT INTO `__new_transactions`("id", "email_id", "provider_id", "wallet_id", "merchant", "amount", "currency", "date", "base_currency", "base_amount", "fx_rate", "fx_date", "category", "source", "type", "notes", "created_at") SELECT "id", "email_id", "provider_id", "wallet_id", "merchant", "amount", "currency", "date", "base_currency", "base_amount", "fx_rate", "fx_date", "category", "source", "type", "notes", "created_at" FROM `transactions`;--> statement-breakpoint
